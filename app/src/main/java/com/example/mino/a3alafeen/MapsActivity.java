...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Obtain the Suppo rtMapFragment and get notified when the map is ready to be used.
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                //Reset marker when already there is 2
                /*
                1 is the start
                2 is the end
                */
...
//        LatLng egypt = new LatLng(26, 31);
//        mMap.addMarker(new MarkerOptions().position(egypt).title("Start point"));
